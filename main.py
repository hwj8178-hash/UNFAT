...
TOOL_DECLARATIONS = [
...
},
    {
        ...
        "description": (
            "역사학 연구 문서(논문, 역사 자료)를 분석합니다. "
            "PDF, HWP(한글), DOCX(워드), JPG, PNG 형식을 지원합니다. "
            "핵심 주장, 연구 방법론, 주요 논거, 연구사 공백을 추출하고, "
            "페이지 번호가 포함된 원문 인용 각주를 생성합니다. "
    ...
    },
    {
        ...
        "description": (
            "특정 문서의 특정 페이지에서 인용문을 찾아 논문 각주 형식으로 반환합니다. "
            "사용자가 '~쪽에서 각주 만들어줘', '~페이지 인용 찾아줘' 등을 요청할 때 사용하세요."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
